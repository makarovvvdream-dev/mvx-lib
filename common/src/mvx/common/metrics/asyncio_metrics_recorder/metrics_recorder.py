# src/mvx/common/metrics/asyncio_metrics_recorder/metrics_recorder.py
...
class AsyncioMetricsRecorder:
    ...
    async def _stop_core(self) -> None:
        ...
        try:
            ...
            try:
                ...
                raise AsyncioMetricsRecorderOnStoppedHookFailedError(cause=exc) from exc
    ...
    @log_invocation(
        ...
        context_fields=("state=self._state",),
        log_kwargs_on_invoke=("metric_name=metric.metric_name",),
    )
