...
def _apply_custom_normalization(
    ...
    *,
    ...
    2) Otherwise, if a callable log_adapter_resolver is provided, tries to get
...
def normalize_primitive(
    ...
    *,
    ...
    - str:
        Returned unchanged unless it exceeds max_str_len when max_str_len is not None,
        in this case it is truncated and suffixed with "...".
    - int/float/bool/None:
...
def _normalize_leaf(
    ...
    *,
    ...
    - Primitive (str/bytes/bytearray/memoryview/int/float/bool/None):
...
def normalize_dict_for_log(
    ...
    *,
    ...
    - Keys are converted to strings; if a key string exceeds max_str_len when
      max_str_len is not None, it is truncated and suffixed with "...".
