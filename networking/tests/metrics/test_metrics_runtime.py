# tests/metrics/test_metrics_runtime.py
...
import mvx.networking.metrics.metrics_runtime.metrics_runtime as runtime_pack
from mvx.networking.metrics.asyncio_metrics_recorder import (
    AsyncioMetricsRecorderQueueOverflowPolicy,
)
from mvx.networking.metrics.metrics_runtime.common import MetricsRuntimeState
from mvx.networking.metrics.metrics_runtime.errors import (
...
def test_i29_create_recorder_accepts_valid_log_context() -> None:
    ...
    log_context = cast(LogContext, object.__new__(LogContext))
    ...
    try:
        ...
        assert recorder._log_context is log_context
        assert runtime._recorders == {"recorder": recorder}
